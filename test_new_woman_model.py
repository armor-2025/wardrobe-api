"""
Test with new female model IMG_6582
"""
import os
import cv2
import numpy as np
...
woman_photo_pil = Image.open(ai_pics_path + 'IMG_6582.PNG')
woman_photo_cv = cv2.imread(ai_pics_path + 'IMG_6582.PNG')
...
if len(results) >= 4:
    ...
    print("\n✅ System validated:")
    print("   - Multiple male models ✓")
    print("   - Multiple female models ✓")
