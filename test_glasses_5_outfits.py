...
print("=" * 70)
print("🎯 TESTING 5 OUTFITS - GLASSES MODEL")
print("=" * 70)
...
- Glasses: Match if present
- Build: Match reference
- Age: Match reference
...
if test_outfit("outfit1_casual", [ai_pics_path + 'IMG_6552.PNG', ai_pics_path + 'blackjeans.png'], "White long sleeve shirt, black jeans"):
    results.append("1")

if test_outfit("outfit2_dress", [ai_pics_path + 'IMG_6563.PNG'], "Red dress, knee-length"):
    results.append("2")

if test_outfit("outfit3_jacket", [ai_pics_path + 'IMG_6555.PNG', ai_pics_path + 'IMG_6577.PNG'], "Navy bomber jacket, blue wide-leg jeans"):
    results.append("3")

if test_outfit("outfit4_jumper", [ai_pics_path + 'IMG_6567.PNG', ai_pics_path + 'IMG_6578.PNG'], "Cream knit jumper, indigo wide-leg jeans"):
    results.append("4")

if test_outfit("outfit5_leather", [ai_pics_path + 'IMG_6564.PNG'], "Brown leather trousers"):
    results.append("5")

print("=" * 70)
print(f"📊 Success: {len(results)}/5")
print("=" * 70)
print("\nopen ~/wardrobe/backend/api/")
